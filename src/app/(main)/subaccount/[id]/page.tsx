...
const SubaccountPageId = async ({ params, searchParams }: Props) => {
  ...
  const subaccountDetails = await subAccountModel.findById(params.id);
  ...
  const funnels = JSON.parse(JSON.stringify(await funnelModel.find({
      ...
      <div className="relative h-full">
        ...
        <div className="flex flex-col gap-4 pb-6">
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <PipelineValue subAccountId={params.id} />
